import type { Browser as PuppeteerBrowser, ProtocolType, PuppeteerLaunchOptions, Page } from 'puppeteer-core';
...
export declare abstract class Browser extends Browser_base implements AsyncDisposable {
    ...
    protected abstract launchPuppeteer(opts: PuppeteerLaunchOptions): Promise<PuppeteerBrowser>;
    /** @internal */
    protected generateLaunchOptions(mergeOptions?: PuppeteerLaunchOptions): Promise<PuppeteerLaunchOptions>;
    /** @internal */
