...
export declare const pdfLib: () => Promise<{
    ...
    setFillingColor: (color: import("pdf-lib/dist/pdf-lib.min.js").Color) => import("pdf-lib/cjs/core/operators/PDFOperator").default;
    setStrokingColor: (color: import("pdf-lib/dist/pdf-lib.min.js").Color) => import("pdf-lib/cjs/core/operators/PDFOperator").default;
